/**
 * H100-benefits-plan-summaries
 * POST https://api.qa2.health100.com/apix/client/experience/v2/load/be18095c-7ec6-4fdc-96b8-ca56f8964800?frn=FRNPlanSummaries
 */
...
module.exports = {
  name: 'H100-benefits-plan-summaries',
  description: 'Get combined plans spending summary for H100 (FRNPlanSummaries)',
  method: 'POST',
  allowFailure: true,
  ...
  async execute(config = {}) {
    ...
    client.setHeaders({
      ...
      'user-agent':                        'Health100Android/26.4.50(2604500); (Google; sdk_gphone64_arm64; SDK 36; Android 16) HEALTH100_APP',
      'quantummetricsessionid':            '65122ec42479baf6f637faf80d4d81fa',
      'x-app-name':                        'H100_APP',
