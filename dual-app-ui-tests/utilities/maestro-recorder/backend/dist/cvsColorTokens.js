...
exports.SEMANTIC_COLOR_MAPPING = exports.COLOR_USAGE_GUIDELINES = exports.DEPRECATED_COLOR_FAMILIES = exports.CVS_COLOR_TOKENS = void 0;
// CVS Core Color Tokens (extracted from Figma)
exports.CVS_COLOR_TOKENS = [
    // ============================================
...
exports.DEPRECATED_COLOR_FAMILIES = ['cobalt'];
// Color family usage guidelines
exports.COLOR_USAGE_GUIDELINES = {
...
exports.SEMANTIC_COLOR_MAPPING = {
    error: ['red'],
    success: ['teal'],
    warning: ['tangerine'],
    info: ['sky'],
...
//# sourceMappingURL=cvsColorTokens.js.map