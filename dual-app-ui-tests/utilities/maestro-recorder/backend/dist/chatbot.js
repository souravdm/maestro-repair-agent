...
exports.getQuickHelpTopics = getQuickHelpTopics;
exports.getFeatureDocumentation = getFeatureDocumentation;
...
function generateContextualSuggestion(message, context) {
    const suggestions = [];
