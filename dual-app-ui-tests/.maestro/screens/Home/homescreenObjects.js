...
output.homescreen_splitview = {
    ...
    tooltip_health_and_pharmacy_body: ".*Check your Rx status, manage upcoming appointments and more",
    tooltip_shop_title: "Find the products you need.*",
    tooltip_shop_body: ".*Shop for your favorite products and find personalized deals",
    tooltip_close_button: "Close",
    cards: "Cards",
    yourCards: "Your cards",
}
output.homescreen_activity = {
    activityHeader: "Activity.*|For you.*",
    ...
    anba_rx_workingonit: "We're working on it|Working on.*",
    anba_rx_prescribercontacted: "Prescriber contacted",
    anba_rx_refill_scheduled: "Refill scheduled",
    anba_rx_refill: "Available for refill|.*Available for refill.*",
    ...
    anba_wereWorkingOnIt: "We're working on it|Working on.*",
    anba_ready: "Ready|.*Ready.*",
    anba_delayed: "Delayed",
    anba_readyForPickup: "Ready for pickup",
    anba_notFilled: ".*Not filled.*|.*not filled.*",
...
output.homescreen_careRecommendations = {
    ...
    getInPersonCareSubtext: "Care for over 190 services at your neighborhood MinuteClinic®.",
